...
public class EstacionamentoApplication {
    ...
    // private List<Ticket> listarTodosTickets(Scanner scanner, TicketService
    // ticketService, FuncionarioService funcionarioService) {
    ...
    // if (funcionario == null) {
    // System.out.println("Você não tem permissão para acessar esta
    // funcionalidade.");
    // return List.of();
    // }
    ...
    // } else {
    // tickets.forEach(ticket -> System.out.println("Ticket " + "Veículo: " +
    // ticket.getVeiculo().getPlaca() + ", Valor: " + ticket.getValor()));
    // }
    // return tickets;
    ...
    // private List<Ticket> listarMeusTickets(Scanner scanner, TicketService
    // ticketService) {
    // System.out.println("\n--- LISTA DE TICKETS ---");
    ...
    // private List<Veiculo> listarMeusVeiculos(Scanner scanner, ClienteService
    // clienteService) {
    // System.out.println("\n--- LISTA DE VEÍCULOS ---");
    // System.out.print("Digite o CPF do cliente: ");
    // String cpf = scanner.nextLine();
    ...
    // if (veiculos.isEmpty()) {
    // System.out.println("Nenhum veículo cadastrado para o cliente " +
    // cliente.getNome());
    // } else {
    // veiculos.forEach(veiculo -> System.out.println("Placa: " + veiculo.getPlaca()
    ...
    // private static void cadastrarVeiculoParaCliente(Scanner scanner,
    ...
    // System.out.println("Veículo cadastrado com sucesso para o cliente " +
    // cliente.getNome());
    // } catch (RuntimeException e) {
    // System.out.println("Erro: " + e.getMessage());
    // }
    ...
    // private static void cadastarFuncionario(Scanner scanner, FuncionarioService
    // funcionarioService) {
    ...
    // private static void criarTicket(Scanner scanner, VeiculoService
    // veiculoService, ClienteService clienteService, FuncionarioService
    // funcionarioService, TicketService ticketService /*,EstacionamentoService
    ...
    // var veiculos =
    // veiculoService.buscarVeiculoPorPlaca(cliente.getVeiculos().getFirst().getPlaca());

    // System.out.println("Nome do Estacionamento: ");
    // // var estacionamento =
    // estacionamentoService.buscarEstacionamentoPorNome(scanner.nextLine());
